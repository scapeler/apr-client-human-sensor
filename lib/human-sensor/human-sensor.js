...
//		http://openiod.com/SCAPE604/openiod?SERVICE=WPS&REQUEST=Execute&identifier=transform_observation&inputformat=projectEhvAirport&objectid=geoLocationArea&lat=51.45401&lng=5.47668&format=xml
		...
		ajaxGetData(_url,
			function(data) {
				...
				apriPages.locationPage.gm_code = result[0].properties.gm_code;
				apriPages.locationPage.gm_naam = result[0].properties.gm_naam;
				apriPages.locationPage.bu_code = result[0].properties.bu_code;
				apriPages.locationPage.bu_naam = result[0].properties.bu_naam;
