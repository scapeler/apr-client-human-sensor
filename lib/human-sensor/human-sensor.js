...
//			  		, {id:'escape', label:'nvt'		, className:'answer-escape', score:0, status:'on' }
			...
			, {category: { id:"noicestress", label:"Geluid", question:"Heeft u nu last van omgevingsgeluiden?"
			  	, answers: [
					  {id:'01', label:'Nee'			, className:'answer-1of3', score:1, status:'off' }
			  		, {id:'02', label:'Neutraal'	, className:'answer-2of3', score:2, status:'off' }
			  		, {id:'03', label:'Ja'			, className:'answer-3of3', score:3, status:'off' }
//			  		, {id:'escape', label:'nvt'		, className:'answer-escape', score:0, status:'on' }
					]
				}}
		...
		apriPages.resultPage.init_page 		= function (container, callBack) {
			...
			_page.cbsBuurtProjectEhvAirportLayer = new L.geoJson(null, {
				...
				, style: function (feature) {
					...
					var categoryColor 			= {};
					categoryColor.noicestress	= {};
					categoryColor.noicestress['01']	= '#00FF00';
					categoryColor.noicestress['02']	= '#FFFF00';
					categoryColor.noicestress['03']	= '#FF0000';
					
					var _color = "#000000";
					var _fillOpacity = 0.2;

					var observedProperty	= 'noicestress'; 
