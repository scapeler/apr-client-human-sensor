...
//			  		, {id:'escape', label:'nvt'		, color:'grey', className:'answer-escape', score:0, status:'on' }
		...
		introText 		= '<H2>Vliegveld Eindhoven sluit, AiREAS onderzoekt effect op de mens</H2><img src="'+apriConfig.urlSystemRoot+'/client/apri-client-human-sensor/images/vliegtuig.jpg"></img><BR/>Het vliegveld van Eindhoven gaat twee weken dicht.<BR/>Twee weken lang niet vliegen, geen verkeer van en naar de luchthaven, alleen 400 vrachtwagens die de start en landingsbaan moeten vernieuwen met asfalt.<BR/><BR/>Dat is een eenmalige kans voor samenwerkingsverband “gezonde gebiedsontwikkeling” AiREAS om eens te kijken wat het effect is van zo´n vliegveld op de mens en omgeving door vóór, tijdens en na de sluiting dat te onderzoeken op gebied van luchtverontreiniging, geluid, stress en gezondheid.<BR/><BR/>De mogelijke unieke contrasten kunnen ons helpen een beeld te scheppen van wat er nodig zou zijn om middels de innovatiekracht van onze Brainport regio te komen tot een zo´n goed mogelijke mobiliteit­oplossing binnen de kaders van een zo gezond mogelijke en leefbare leefomgeving.<BR/><a href="https://aireas.wordpress.com/2016/04/28/vliegveld-eindhoven-sluit-aireas-onderzoekt-effect-op-de-mens/" target="_blank">Meer informatie</a><BR/><BR/>'; 
...
//			_displayElements.pageBodyElement.appendChild(_displayElements.locationPageLocationDescriptionElement);
			...
			_displayElements.pageTabContentAutoElement.appendChild(_displayElements.locationPageMapElement);
