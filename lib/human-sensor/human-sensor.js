...
//		source.addEventListener('remove', removeHandler, false);
	...
	var pushMessageHandler	= function(e) {
        console.log('Push message from server '+e.type + ": " + (e.type === "humansensordata" ? e.data : source.url));
		if (e.type == "humansensordata") {
			if (displayElements.notification) {
				var messageData = JSON.parse(e.data);
				displayElements.notification.classList.add('notification-enabled');
				displayElements.notification.innerHTML	= messageData.action.text;
				setTimeout(function() {
