...
//	}
	...
	this.constructor = function(objectId, options) {
		...
		resultText = '<H3>Dit zijn de resultaten van het afgelopen uur. Hoe doet uw buurt het?</H3>TEST!<img style="float:right;width:80%;" src="'+apriConfig.urlSystemRoot+'/client/apri-client-human-sensor/images/resultaat-test.png"></img><BR><BR><BR>'; 
