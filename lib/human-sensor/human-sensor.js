...
//		setPushState();
	...
	this.initView = function() {
		...
		this.getTemplate(_template, {urlSystemRoot: apriConfig.urlSystemRoot, appPath: 'client/', app: 'human-sensor' }, {}, function(result) {
			...
			screenInfoElement.innerHTML = ' ('+window.innerWidth+'x'+window.innerHeight+';dpr1:'+jsPixelRatio()+';dpr2:'+dprMethode2+')';
...
//			apriPagesFixedElement.style.top = (appFooterTop - apriHeaderHeight) + 'px';
			...
			succesPageBodyElement.appendChild(succesPageContentElement);
			...
			resultPageBodyElement.appendChild(resultPageContentElement);
