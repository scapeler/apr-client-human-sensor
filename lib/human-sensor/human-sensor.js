...
//	}
	...
	this.constructor = function(objectId, options) {
		...
		introText = '<H3>Hoe beleeft u uw leefomgeving?</H3><img style="float:right;width:85%;" src="'+apriConfig.urlSystemRoot+'/client/apri-client-human-sensor/images/scapeler-od-idee.png"></img> <BR><BR><BR>'; 
