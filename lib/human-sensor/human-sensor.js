...
//	}
	...
	this.constructor = function(objectId, options) {
		...
		introText = '<H2>Hoe beleeft u uw leefomgeving?</H2><img style="float:right;width:14rem;" src="'+apriConfig.urlSystemRoot+'/client/apri-client-human-sensor/images/scapeler-od-idee.png"></img> <BR><BR><BR>'; 
