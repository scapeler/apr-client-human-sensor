...
//	}
	...
	this.constructor = function(objectId, options) {
		...
		succesText = 'Bedankt voor uw deelname. Uw beleving van de leefomgeving is belangrijk voor het onderzoek. Ga door na de volgende pagina om de resultaten van de afgelopen periode te kunnen bekijken.<BR><BR><BR>'; 
...
//			L.tileLayer.wms('http://www.openbasiskaart.nl/mapcache?SRS=EPSG%3A4326', {
//			L.tileLayer('http://www.openbasiskaart.nl/mapcache', {
				layers: 'osm',
				format: 'image/png',
				transparent: true,
				tiled: true,
