...
//	}
	...
	this.constructor = function(objectId, options) {
		...
		resultText 		= '<H3>Hoe doet uw buurt het?</H3>TEST!<BR/>Dit zijn de resultaten van de afgelopen 24 uur. <BR/>'; 
...
//				}
		...
		apriPages.resultPage.init_page 		= function (container, callBack) {
			...
			_displayElements.resultPageMapElement.style.height='18rem';
			_displayElements.resultPageMapElement.style.width='18rem';
