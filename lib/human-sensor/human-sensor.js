...
//	}
	...
	this.constructor = function(objectId, options) {
		...
		resultText 		= '<H3>Dit zijn de resultaten van de afgelopen 24 uur. Hoe doet uw buurt het?</H3>TEST!<BR/><BR/><BR/>'; 
...
//			apriPages.aboutPage.init();
			...
			displayElements.mainMenuButton.addEventListener('click', function(event) {
...
//				}
		...
		apriPages.resultPage.init_page 		= function (container, callBack) {
			...
			_displayElements.resultPageMapElement.style.height='20rem';
			_displayElements.resultPageMapElement.style.width='20rem';
