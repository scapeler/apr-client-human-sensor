...
*/
		...
		introText 		= '<H3>Hoe ervaart u nu uw leefomgeving?</H3><img src="'+apriConfig.urlSystemRoot+'/client/apri-client-human-sensor/images/scapeler-od-idee.png"></img><BR/><BR/><BR/>'; 
		...
		surveyText		= '<H3>Vragenlijst</H3>Hier kunt u uw beleving van de leefomgeving per categorie aangeven.';
