...
var twmInit	= function() {
	...
	twm.fase.A001.begin	= function(m) {
		...
		if (_fase.notifications.notification) {
			var innerHTMLText = '';
			_fase.notifications.notification.classList.add('notification-enabled');
			...
			if (geoLocation.automatic == false) {
				...
				innerHTMLText += error;
				_fase.notifications.notification.classList.add('notification-error');
				playSound(); // beep
			}
			_fase.notifications.notification.innerHTML	= innerHTMLText;
			setTimeout(function() {
				twm.fase.A001.close();
			},timeToGo);
		}	
	...
	twm.fase.A001.close	= function() {
		...
		if (twm.activeFaseId=='A001A'||twm.activeFaseId=='A001B') {
			...
			if (_notifications.notification) {
				...
				_notifications.notification.innerHTML	= '';
			}
	...
	twm.fase.A002.begin	= function(m) {
		...
		if (_fase.notifications.notification) {
			_fase.notifications.notification.classList.add('notification-enabled');
			_fase.notifications.notification.innerHTML	= m.text;
			setTimeout(function() {
				twm.fase.A002.close();
			},timeToGo);
		}	
