...
//		setPushState();
	...
	this.initView = function() {
		...
		this.getTemplate(_template, {urlSystemRoot: apriConfig.urlSystemRoot, appPath: 'client/', app: 'human-sensor' }, {}, function(result) {
			...
			var apriPageFooterFixedElements = appBodyContainer.getElementsByClassName("apri-page-footer-fixed");
			var footerOffsetHeight, _top;
			for (var i=0;i<apriPageFooterFixedElements.length;i++) {
			 	footerOffsetHeight = apriPageFooterFixedElements[i].offsetHeight>0?apriPageFooterFixedElements[i].offsetHeight:footerOffsetHeight;
				_top = (appFooterTop - footerOffsetHeight) + 'px';
				apriPageFooterFixedElements[i].style.top = _top;
			}

			var apriHeaderHeight = 120; /* in px */;
			/* position pages */
...
//			apriPagesFixedElement.style.top = (appFooterTop - apriHeaderHeight) + 'px';
			...
			for (var i=0;i<apriPageElements.length;i++) {
				apriPageElements[i].style.height = (appFooterTop - footerOffsetHeight - apriHeaderHeight) + 'px'; 
			}
			//var pagesOffsetHeight, _top;
