...
//	}
	...
	this.constructor = function(objectId, options) {
		...
		introText 		= '<H3>Hoe beleeft u uw leefomgeving?</H3><img src="'+apriConfig.urlSystemRoot+'/client/apri-client-human-sensor/images/scapeler-od-idee.png"></img><BR/><BR/><BR/>'; 

		locationText 	= '<H3>In welke buurt bevindt u zich?</H3>U kunt hier uw huidige locatie aangeven. Indien de locatie op de kaart niet helemaal juist is, kunt u de marker verplaatsen naar de buurt waarin u zich bevindt.<BR/><BR/>'   
	
		surveyText		= '<H3>Vragenlijst</H3>Hier kunt u uw beleving van de leefomgeving per categorie aangeven. Indien u het antwoord op "nvt" laat staan dan zal de betreffende categorie niet worden verwerkt. U kunt maximaal 1x per 10-minuten uw keuzes verzenden.';
		...
		resultText 		= '<H3>Hoe doet uw buurt het?</H3>TEST! Dit zijn de resultaten van de afgelopen 24 uur. <BR/>'; 
...
//var _url= "http://openiod.com/SCAPE604/openiod?SERVICE=WPS&REQUEST=Execute&identifier=transform_observation&inputformat=projectEhvAirport&objectid=areas&format=xml"
		...
		ajaxGetData(_url,
			function(data) {
				...
				apriPages.resultPage.gm_code	= geoLocation.cityCode;
				apriPages.resultPage.gm_naam	= geoLocation.cityName;
				apriPages.resultPage.bu_code	= geoLocation.neighborhoodCode;
				apriPages.resultPage.bu_naam	= geoLocation.neighborhoodName;
								
				apriPages.resultPage.displayElements.locationPageNeighborhoodContentElement.innerHTML =  apriPages.locationPage.bu_naam;
				apriPages.resultPage.displayElements.locationPageCityContentElement.innerHTML 		=  apriPages.locationPage.gm_naam;
				*/
...
//				}
		...
		apriPages.locationPage.init_page 		= function (container, callBack) {
			...
			_displayElements.locationPageMapElement.style.height='15rem';
			_displayElements.locationPageMapElement.style.width='15rem';
...
//				}
		...
		apriPages.resultPage.init_page 		= function (container, callBack) {
			...
			_displayElements.resultPageMapElement.style.height='15rem';
			_displayElements.resultPageMapElement.style.width='15rem';
