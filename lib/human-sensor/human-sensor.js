...
//		setPushState();
	...
	this.initView = function() {
		...
		this.getTemplate(_template, {urlSystemRoot: apriConfig.urlSystemRoot, appPath: 'client/', app: 'human-sensor' }, {}, function(result) {
			...
			var offsetHeight, _top;
			for (var i=0;i<apriPageFooterFixedElements.length;i++) {
			 	offsetHeight = apriPageFooterFixedElements[i].offsetHeight>0?apriPageFooterFixedElements[i].offsetHeight:offsetHeight;
				_top = (appFooterTop - offsetHeight) + 'px';
