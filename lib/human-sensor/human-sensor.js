...
*/
		...
		resultText 		= '<H2>Hoe doet uw buurt het?</H2>TEST! Dit zijn de resultaten van de afgelopen 24 uur. Het kan even duren voordat uw reactie verwerkt is en hier in beeld komt. Gebruik de "Vernieuw data" knop om nieuwe data op te halen.<BR/></BR>'; 
...
//				}
		...
		apriPages.resultPage.init_page 		= function (container, callBack) {
			...
			_displayElements.pageContentElement = document.createElement('div');
			_displayElements.pageContentElement.innerHTML = 'Kies hier de categorie en periode<BR/> ';
			_displayElements.pageBodyElement.appendChild(_displayElements.pageContentElement);
