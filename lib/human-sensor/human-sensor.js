...
//		setPushState();
	...
	this.initView = function() {
		...
		this.getTemplate(_template, {urlSystemRoot: apriConfig.urlSystemRoot, appPath: 'client/', app: 'human-sensor' }, {}, function(result) {
			...
			var apriMenuFooterFixedElement = appBodyContainer.getElementsByClassName("apri-menu-fixed")[0];
			var apriHeaderHeight = apriMenuFooterFixedElement.offsetHeight;
...
//			apriMenuFooterFixedElement.style.top = (appFooterTop) + 'px';
			...
			/* position pages */
			var apriPagesFixedElement = appBodyContainer.getElementsByClassName("apri-view-pages-fixed")[0];
//			var pagesOffsetHeight, _top;
//			apriPagesFixedElement.style.top = (appFooterTop - apriHeaderHeight) + 'px';
			apriPagesFixedElement.style.top = (apriHeaderHeight) + 'px';
			apriPagesFixedElement.style.height = (appFooterTop - apriHeaderHeight) + 'px';

			/* height per page */
			var apriPageElements = appBodyContainer.getElementsByClassName("apri-page");
			for (var i=0;i<apriPageElements.length;i++) {
				apriPageElements[i].style.height = (appFooterTop - apriHeaderHeight) + 'px'; 
			}
			//var pagesOffsetHeight, _top;
			//apriPagesFixedElement.style.top = appFooterTop - apriPagesFixedElement.offsetHeight;


			/* position pages footer */
			var apriPageFooterElements = appBodyContainer.getElementsByClassName("apri-page-footer");
			var footerOffsetHeight, _top;
			for (var i=0;i<apriPageFooterElements.length;i++) {
			 	footerOffsetHeight = apriPageFooterElements[i].offsetHeight>0?apriPageFooterElements[i].offsetHeight:footerOffsetHeight;
				_top = (appFooterTop - apriHeaderHeight - footerOffsetHeight) + 'px';
				apriPageFooterElements[i].style.top = _top;
			}
			...
			var introPageBodyElement 	= introPage.getElementsByClassName("apri-view-body")[0];
			introPageBodyElement.style.height = (appFooterTop - apriHeaderHeight - footerOffsetHeight)+ 'px';
			...
			introPageContentElement.innerHTML = introText;
			introPageBodyElement.appendChild(introPageContentElement);
			
			var introPageActionNextPageElement 	= introPage.getElementsByClassName("apri-page-actions")[0];
			...
			var locationPageBodyElement 	= locationPage.getElementsByClassName("apri-view-body")[0];
			locationPageBodyElement.style.height = (appFooterTop - apriHeaderHeight - footerOffsetHeight)+ 'px';
						
			var locationPageActionNextPageElement 	= locationPage.getElementsByClassName("apri-page-actions")[0];
			...
			var surveyPageBodyElement 	= surveyPage.getElementsByClassName("apri-view-body")[0];
			surveyPageBodyElement.style.height = (appFooterTop - apriHeaderHeight - footerOffsetHeight)+ 'px';
						
			var surveyPageActionNextPageElement 	= surveyPage.getElementsByClassName("apri-page-actions")[0];
			...
			var succesPageBodyElement 	= succesPage.getElementsByClassName("apri-view-body")[0];
			succesPageBodyElement.style.height = (appFooterTop - apriHeaderHeight - footerOffsetHeight)+ 'px';
						
			var succesPageActionNextPageElement 	= succesPage.getElementsByClassName("apri-page-actions")[0];
			...
			var resultPageBodyElement 	= resultPage.getElementsByClassName("apri-view-body")[0];
			resultPageBodyElement.style.height = (appFooterTop - apriHeaderHeight - footerOffsetHeight)+ 'px';
						
			var resultPageActionNextPageElement 	= resultPage.getElementsByClassName("apri-page-actions")[0];
			...
			var aboutPageBodyElement 	= aboutPage.getElementsByClassName("apri-view-body")[0];
			aboutPageBodyElement.style.height = (appFooterTop - apriHeaderHeight - footerOffsetHeight)+ 'px';
						
			var aboutPageActionNextPageElement 	= aboutPage.getElementsByClassName("apri-page-actions")[0];
			...
			aboutPageBodyElement.appendChild(contentElement);	
			aboutPageBodyElement.appendChild(textElement);	
